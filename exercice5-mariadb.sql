...
SELECT * FROM `student` INNER JOIN `student_tag` ON student.id = student_tag.student_id; 

-- Exo 5.2
-- Listez tous les tags avec leurs students
SELECT * FROM `student_tag` INNER JOIN `student` ON student_tag.student_id = student.id; 

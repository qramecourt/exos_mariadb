...
SELECT * FROM `student` WHERE email LIKE "%.fr%" OR created_at <= "2021-10-01"; 
-- Exo 3.2
-- Listez les students :
-- - dont l'email contient la chaîne de caractères `.fr`
-- - ET dont la date de création est antérieure au 10 janvier 2021 inclus
SELECT * FROM `student` WHERE email LIKE "%.fr%" AND created_at <= "2021-10-01"; 
-- Exo 3.3
-- Listez les students :
-- - dont la date de création est postérieure au 1er janvier 2021 exclus
-- - ET dont la date de création est antérieure au 10 janvier 2021 inclus
SELECT * FROM `student` WHERE created_at <= "2021-01-01" AND updated_at >="2021-01-10"; 
-- Exo 3.4
-- Listez les projects :
